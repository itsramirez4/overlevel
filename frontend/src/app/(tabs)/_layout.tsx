...
// Pulled from <Tabs>'s own prop type instead of importing react-navigation's
// BottomTabBarProps directly — expo-router vendors it internally without
// re-exporting it from the public package.
