  ...
  return (
    <View>
      ...
      <Button
        ...
        onPress={() =>
          onSubmit({
            // Trimmed here, not left to each caller — every current caller
            // guards with `if (!data.name)`, which a whitespace-only value
            // slips past untrimmed (exercise-edit.tsx's equivalent form
            // does trim, this one didn't).
            name: name.trim(),
            pattern,
